        ...
        {client => {
          ...
          return (
            <div className="review-container">
              <Query query={BOOK_BY_ID} variables={{ _id: this.state.book }}>
                {({ loading, error, data }) => {
                  ...
                  <div className="review-form-container">
                    <form onSubmit={e => this.handleSubmit(e, newReview)}>
                      ...
                      <div className="review-form-recommend-to-container">
                        <label htmlFor="review-form-recommend-to">
                      ...
                      <div className="review-form-owned-container">
                        <input
                          ...
                          type="checkbox"
                        ></input>
                        <label htmlFor="review-form-owned ">
