                    ...
                    <div className='navbar-contents'>
                      ...
                      <nav className='main-nav'>
                        <ul className='nav-list'>
                          ...
                          <li className='nav-list-item'>
                            <Link to='/bookshelf' className='nav-link'>My Books</Link> {/* Change link later to bookshelf */}
                          </li>
                          <li className='nav-list-item'>
                      ...
                      <div className='personal-nav'>
                        <ul className='personal-nav-list'>
                          <li className='personal-nav-list-item'>
                            <Link to='/group' className='personal-link'><i class='far fa-comments'></i></Link>
                          </li>
                          <li className='personal-nav-list-item'>
                            <Link to='/inbox' className='personal-link'><i class="fa fa-envelope-o"></i></Link>
                          </li>
                          <li className='personal-nav-list-item'>
                            <Link to='/friend' className='personal-link'><i class='fas fa-user-friends'></i></Link>
                          </li>
                          <li className='personal-nav-list-item'>
