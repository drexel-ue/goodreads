  ...
  return (
    <div className="bookshelf">
      ...
      <div className="shelves">
        ...
        <Link to="/bookshelf/all" className="shelf">
          All
        </Link>
        <Link to="/" className="shelf">
          Read
        </Link>
        <Link to="/" className="shelf">
          Currently Reading
                        ...
                        <table className="bookshelf-content">
                          <thead className="table-content">
                            <tr className="table-cols">
                              <th className="table-col cover-col">
                                <Link to="/">cover</Link>
                              </th>
                              <th className="table-col title-col">
                                <Link to="/">title</Link>
                              </th>
                              <th className="table-col author-col">
                                <Link to="/">author</Link>
                              </th>
                              <th className="table-col rating-col">
                                <Link to="/">avg rating</Link>
                              </th>
                              <th className="table-col rate-col">
                                <Link to="/">rating</Link>
                              </th>
                              <th className="table-col shelves-col">
                                <Link to="/">shelves</Link>
                              </th>
                              <th className="table-col read-col">
                                <Link to="/">date read</Link>
                              </th>
                              <th className="table-col added-col">
